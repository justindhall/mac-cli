...
alias zprofile='subl ~/.bash_profile'
...
alias reset_puma="cd /Users/sam.birk/.puma-dev/; find . -type l -exec unlink {} \\; cd -;"
...
source $ROUNDTRIP_WORKSPACE_DIRECTORY/mac-cli/dist/profiles/gem_credentials.sh
...
source $ROUNDTRIP_WORKSPACE_DIRECTORY/mac-cli/dist/profiles/repos.sh
...
source $ROUNDTRIP_WORKSPACE_DIRECTORY/mac-cli/dist/profiles/sync.sh
